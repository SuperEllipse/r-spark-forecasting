...
Let us save these results as a separate dataset
```{r}

#spark_write_csv(last_3_years, path = "s3a://go01-demo/data/iowa-liquor-sales/Iowa_Liquor_Sales_3yrs.csv",  mode = "overwrite")
