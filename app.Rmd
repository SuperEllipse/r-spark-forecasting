...
```
Helper function to read data from a small forecasting datafile 
...
let us launch the Feast UI

```{r}
shinyApp(ui=ui, server=server, options=list(host="127.0.0.1", port=8100))
```